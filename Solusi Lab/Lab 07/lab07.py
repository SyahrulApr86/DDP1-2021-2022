...
def tujuan_kelas(tujuan_akhir, kelas_kereta):
...
def tujuan_jam(tujuan_akhir, jam_keberangkatan):
...
4. EXIT""")
    ...
    if perintah[0] == "INFO_TUJUAN" :
        ...
        if perintah[0] == "TUJUAN_KELAS":
            tujuan_kelas(perintah[1], perintah[2])
        elif perintah[0] == "TUJUAN_JAM":
            tujuan_jam(perintah[1], perintah[2])
        else:
